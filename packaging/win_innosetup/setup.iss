...
; - SourceDir: Path to the repository root
...
MinVersion=10.0
OutputDir=build
OutputBaseFilename=Rare_{#AppVersion}_setup_win64
...
WizardImageFile=rare\resources\images\cover.png
WizardImageFileDynamicDark=rare\resources\images\cover.png
